...
PRE_ANALYZED = [
    ...
    },
    {
        ...
        "draft_email_body": (
            ...
            "So that we can look into this and resolve it as quickly as possible, could you please share a few details?\n\n"
            "- Your order number\n"
            "- A brief description of what happened (e.g. did the screen go blank, did it fail to charge?)\n"
            "- Any photos of the issue, if possible\n\n"
            "Once we have these details, our team will review your case promptly and get back to you with next steps.\n\n"
